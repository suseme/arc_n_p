...
* [PART ONE: INTRODCUTION 第一部分：简介](part1/00.intro.md)
  * [1 What Is Software Architecture什么是软件构架](part1/01.what_is_sw_arch.md)
    * [1.1 What Software Architecture Is and What It Isn't](01.1.what_sw_arch_is_and_what_it_isnt.md)
    * [1.2 Architectural Structures and Views](01.2.arch_structures_and_views.md)
    * [1.3 Architectural Patterns](01.3.arch_patterns.md)
    * [1.4 What Makes a "Good" Architecture?](01.4.what_makes_a_good_arch.md)
    * [1.5 Summary](01.5.summay.md)
    * [1.6 For Further Reading](01.6.for_further_reading.md)
    * [1.7 Discussion Questions](01.7.discussion_questions.md)
  * [2 Why Is Software Architecture Important?为什么说软件构架非常重要？](part1/02.why_is_sw_arch_important.md)
    * [2.1 Inhibiting or Enabling a System’s Quality Attributes](02.1.inhibiting_or_enable_a_sys_quality_attr.md)
    * [2.2 Reasoning About and Managing Change](02.2.reasoning_about_and_mgr_change.md)
    * [2.3 Predicting System Qualities](02.3.predicting_sys_qualities.md)
    * [2.4 Enhancing Communication among Stakeholders](02.4.enhancing_communication_among_stackholders.md)
    * [2.5 Carrying Early Design Decisions](02.5.carrying_early_design_decisions.md)
    * [2.6 Defining Constraints on an Implementation](02.6.defining_constrains_on_an_implementation.md)
    * [2.7 Influencing the Organizational Structure](02.6.influencing_the_organizational_structure.md)
...
* [PART TWO: QUALITY ATTRIBUTES 第二部分：质量属性](part2/00.quality_attributes.md)
  ...
  * [5 Avaibility 可用性](part2/05.availability.md)
